...
#ifndef MATE_CANVAS_TEXT_H
#define MATE_CANVAS_TEXT_H
...
#define MATE_TYPE_CANVAS_TEXT            (mate_canvas_text_get_type ())
#define MATE_CANVAS_TEXT(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), MATE_TYPE_CANVAS_TEXT, MateCanvasText))
#define MATE_CANVAS_TEXT_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), MATE_TYPE_CANVAS_TEXT, MateCanvasTextClass))
#define MATE_IS_CANVAS_TEXT(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), MATE_TYPE_CANVAS_TEXT))
#define MATE_IS_CANVAS_TEXT_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), MATE_TYPE_CANVAS_TEXT))
#define MATE_CANVAS_TEXT_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), MATE_TYPE_CANVAS_TEXT, MateCanvasTextClass))


typedef struct _MateCanvasText MateCanvasText;
typedef struct _MateCanvasTextClass MateCanvasTextClass;

typedef struct _MateCanvasTextPrivate MateCanvasTextPrivate;

struct _MateCanvasText {
	MateCanvasItem item;
