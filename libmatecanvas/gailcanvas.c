...
gail_canvas_get_type (void)
{
  ...
  if (!type)
    {
      GType parent_type = g_type_parent (MATE_TYPE_CANVAS);      
...
gail_canvas_init (void)
{
  ...
  atk_registry_set_factory_type (atk_get_default_registry (),
				 MATE_TYPE_CANVAS_GROUP, 
				 gail_canvas_group_factory_get_type ());
  atk_registry_set_factory_type (atk_get_default_registry (),
				 MATE_TYPE_CANVAS_TEXT, 
				 gail_canvas_text_factory_get_type ());
  atk_registry_set_factory_type (atk_get_default_registry (),
				 MATE_TYPE_CANVAS_RICH_TEXT, 
				 gail_canvas_text_factory_get_type ());
  atk_registry_set_factory_type (atk_get_default_registry (),
...
gail_canvas_new (GtkWidget *widget)
{
  ...
  g_return_val_if_fail (MATE_IS_CANVAS (widget), NULL);
...
gail_canvas_get_n_children (AtkObject* obj)
{
  ...
  g_return_val_if_fail (MATE_IS_CANVAS (widget), 0);

  canvas = MATE_CANVAS (widget);
  root_group = mate_canvas_root (canvas);
